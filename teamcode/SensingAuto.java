 ...
 */
@TeleOp
public class SensingAuto extends LinearOpMode
{
    ...
    public static class FreightDeterminationPipeline extends OpenCvPipeline
    {
         ...
         */
        static final Point REGION1_TOPLEFT_ANCHOR_POINT = new Point(50,98);
        static final Point REGION2_TOPLEFT_ANCHOR_POINT = new Point(150,98);
        static final Point REGION3_TOPLEFT_ANCHOR_POINT = new Point(260,98);
