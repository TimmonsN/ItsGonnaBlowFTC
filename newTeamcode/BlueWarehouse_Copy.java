...
public class BlueWarehouse_Copy extends LinearOpMode{
...
private void rotate(int turn) {
    ...
    private void ready(int level){
        ...
        int levelDist2 = -3050;
        int levelDist3 = -2200;
        double levelBuck1 = .28;
        double levelBuck2 = .45;
    ...
    public void place(){
        bucket.setPosition(bucket.getPosition() + .09);
        clamp.setPosition(.24);
        sleep(1000);
        bucket.setPosition(bucket.getPosition() - .09);
        sleep(500);
        move(.25,5);
